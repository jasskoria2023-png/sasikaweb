import {
  ...
  Landmark, Sprout, Wallet, Building2, ArrowUpRight, ShieldCheck, BarChart3, PieChart, FlagIcon, Handshake, Target, TrendingUp, Lightbulb, Users, Blocks, Play, FileQuestion, DollarSign, Rocket, Crown
} from 'lucide-react';
import Image from 'next/image';
import RegistrationForm from './components/RegistrationForm';
import Footer from './components/Footer';
import ImageSlider from './components/ImageSlider';
import HorizontalFlagBar from './components/HorizontalFlagBar'
...
interface CountryFlagProps {
  countryCode: string; // e.g., 'us', 'gb', 'fr' (ISO 3166-1 alpha-2 lowercase)
  squared?: boolean;
}
