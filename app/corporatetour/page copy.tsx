import { 
  Handshake, Building2, GraduationCap, Globe2, 
  ShieldCheck, Zap, Share2, ArrowUpRight 
} from 'lucide-react';
...
export default function PartnersPage() {
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-slate-900 py-15 px-6">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-8">
            Corporate Escapes:  <br />
            <span className="text-emerald-500">Seamless Business & Incentive Journeys.</span>
          </h1>
          <p className="text-xl text-slate-400 max-w-3xl leading-relaxed">
          Streamline your corporate travel with complete management for group tours, trade delegations, and retreats—handling flights, visas, venues, and 24/7 support. </p>
        </div>
      </section>
